...
賽程資料來源為賽程表圖片,已以裁切放大方式逐格辨識,並經使用者核對確認(24 週 / 19 場比賽 / 5 次輪休)。

2026-08-25 依聯盟釋出的「8/24 確認版本」更新:2026-10-10 與 2027-03-20 兩場開賽時間由 17:45 提前為 12:05,對手、背心顏色與輪休週次均未變動,各月發送次數與額度不受影響。
